...
export default class Test11 extends Component {
  ...
  render() {
    return (
        ...
        // <button onClick={() => this.clickHandler()}>Click Me</button> // arrow function way of caller way
        
        // <button onClick={this.clickHandler}>Click Me</button> // normal function way of calling by binding it in constructor with this object
